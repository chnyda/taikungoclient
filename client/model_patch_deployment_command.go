...
// checks if the PatchDeploymentCommand type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchDeploymentCommand{}

// PatchDeploymentCommand struct for PatchDeploymentCommand
...
func (o PatchDeploymentCommand) MarshalJSON() ([]byte, error) {
...
func (o PatchDeploymentCommand) ToMap() (map[string]interface{}, error) {
...
type NullablePatchDeploymentCommand struct {
	value *PatchDeploymentCommand
	isSet bool
}

func (v NullablePatchDeploymentCommand) Get() *PatchDeploymentCommand {
	return v.value
}

func (v *NullablePatchDeploymentCommand) Set(val *PatchDeploymentCommand) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchDeploymentCommand) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchDeploymentCommand) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchDeploymentCommand(val *PatchDeploymentCommand) *NullablePatchDeploymentCommand {
	return &NullablePatchDeploymentCommand{value: val, isSet: true}
}

func (v NullablePatchDeploymentCommand) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchDeploymentCommand) UnmarshalJSON(src []byte) error {
	v.isSet = true
