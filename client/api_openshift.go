...
func (r ApiOpenshiftValidateRequest) Execute() (string, *http.Response, error) {
...
// Execute executes the request
//  @return string
func (a *OpenshiftApiService) OpenshiftValidateExecute(r ApiOpenshiftValidateRequest) (string, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
